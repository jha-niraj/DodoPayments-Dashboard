...
const transactionData = {
    ...
    outgoing: [
        {
            id: 5, title: "Starbucks", description: "Morning coffee run", amount: 12.50, date: "Sep 18",
            icon: (
                <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M16 16C16 16.1989 15.921 16.3897 15.7803 16.5303C15.6397 16.671 15.4489 16.75 15.25 16.75H4.75C4.55109 16.75 4.36032 16.671 4.21967 16.5303C4.07902 16.3897 4 16.1989 4 16V9.25H1.75L9.49525 2.209C9.63333 2.08336 9.81331 2.01373 10 2.01373C10.1867 2.01373 10.3667 2.08336 10.5048 2.209L18.25 9.25H16V16ZM6.625 10.75C6.625 11.6451 6.98058 12.5036 7.61351 13.1365C8.24645 13.7694 9.10489 14.125 10 14.125C10.8951 14.125 11.7535 13.7694 12.3865 13.1365C13.0194 12.5036 13.375 11.6451 13.375 10.75H11.875C11.875 11.2473 11.6775 11.7242 11.3258 12.0758C10.9742 12.4275 10.4973 12.625 10 12.625C9.50272 12.625 9.02581 12.4275 8.67417 12.0758C8.32254 11.7242 8.125 11.2473 8.125 10.75H6.625Z" fill="#1FC16B" />
                </svg>
        ...
        {
            id: 6, title: "Electric Bill", description: "Monthly utility payment", amount: 145.20, date: "Sep 16",
            icon: (
                <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M16 16C16 16.1989 15.921 16.3897 15.7803 16.5303C15.6397 16.671 15.4489 16.75 15.25 16.75H4.75C4.55109 16.75 4.36032 16.671 4.21967 16.5303C4.07902 16.3897 4 16.1989 4 16V9.25H1.75L9.49525 2.209C9.63333 2.08336 9.81331 2.01373 10 2.01373C10.1867 2.01373 10.3667 2.08336 10.5048 2.209L18.25 9.25H16V16ZM6.625 10.75C6.625 11.6451 6.98058 12.5036 7.61351 13.1365C8.24645 13.7694 9.10489 14.125 10 14.125C10.8951 14.125 11.7535 13.7694 12.3865 13.1365C13.0194 12.5036 13.375 11.6451 13.375 10.75H11.875C11.875 11.2473 11.6775 11.7242 11.3258 12.0758C10.9742 12.4275 10.4973 12.625 10 12.625C9.50272 12.625 9.02581 12.4275 8.67417 12.0758C8.32254 11.7242 8.125 11.2473 8.125 10.75H6.625Z" fill="#1FC16B" />
                </svg>
        ...
        {
            id: 7, title: "Uber Ride", description: "Trip to airport", amount: 45.00, date: "Sep 15",
            icon: (
                <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M16 16C16 16.1989 15.921 16.3897 15.7803 16.5303C15.6397 16.671 15.4489 16.75 15.25 16.75H4.75C4.55109 16.75 4.36032 16.671 4.21967 16.5303C4.07902 16.3897 4 16.1989 4 16V9.25H1.75L9.49525 2.209C9.63333 2.08336 9.81331 2.01373 10 2.01373C10.1867 2.01373 10.3667 2.08336 10.5048 2.209L18.25 9.25H16V16ZM6.625 10.75C6.625 11.6451 6.98058 12.5036 7.61351 13.1365C8.24645 13.7694 9.10489 14.125 10 14.125C10.8951 14.125 11.7535 13.7694 12.3865 13.1365C13.0194 12.5036 13.375 11.6451 13.375 10.75H11.875C11.875 11.2473 11.6775 11.7242 11.3258 12.0758C10.9742 12.4275 10.4973 12.625 10 12.625C9.50272 12.625 9.02581 12.4275 8.67417 12.0758C8.32254 11.7242 8.125 11.2473 8.125 10.75H6.625Z" fill="#1FC16B" />
                </svg>
            ), iconBg: "bg-black/5", iconColor: "text-black"
        },
    ],
    pending: [
        {
            id: 8, title: "Freelance Payment", description: "Pending clearance from Upwork", amount: 450.00, date: "Est. Sep 20",
            icon: (
                <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M16 16C16 16.1989 15.921 16.3897 15.7803 16.5303C15.6397 16.671 15.4489 16.75 15.25 16.75H4.75C4.55109 16.75 4.36032 16.671 4.21967 16.5303C4.07902 16.3897 4 16.1989 4 16V9.25H1.75L9.49525 2.209C9.63333 2.08336 9.81331 2.01373 10 2.01373C10.1867 2.01373 10.3667 2.08336 10.5048 2.209L18.25 9.25H16V16ZM6.625 10.75C6.625 11.6451 6.98058 12.5036 7.61351 13.1365C8.24645 13.7694 9.10489 14.125 10 14.125C10.8951 14.125 11.7535 13.7694 12.3865 13.1365C13.0194 12.5036 13.375 11.6451 13.375 10.75H11.875C11.875 11.2473 11.6775 11.7242 11.3258 12.0758C10.9742 12.4275 10.4973 12.625 10 12.625C9.50272 12.625 9.02581 12.4275 8.67417 12.0758C8.32254 11.7242 8.125 11.2473 8.125 10.75H6.625Z" fill="#1FC16B" />
                </svg>
        ...
        {
            id: 9, title: "Bank Transfer", description: "Transfer to Savings", amount: 1000.00, date: "Processing",
            icon: (
                <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M16 16C16 16.1989 15.921 16.3897 15.7803 16.5303C15.6397 16.671 15.4489 16.75 15.25 16.75H4.75C4.55109 16.75 4.36032 16.671 4.21967 16.5303C4.07902 16.3897 4 16.1989 4 16V9.25H1.75L9.49525 2.209C9.63333 2.08336 9.81331 2.01373 10 2.01373C10.1867 2.01373 10.3667 2.08336 10.5048 2.209L18.25 9.25H16V16ZM6.625 10.75C6.625 11.6451 6.98058 12.5036 7.61351 13.1365C8.24645 13.7694 9.10489 14.125 10 14.125C10.8951 14.125 11.7535 13.7694 12.3865 13.1365C13.0194 12.5036 13.375 11.6451 13.375 10.75H11.875C11.875 11.2473 11.6775 11.7242 11.3258 12.0758C10.9742 12.4275 10.4973 12.625 10 12.625C9.50272 12.625 9.02581 12.4275 8.67417 12.0758C8.32254 11.7242 8.125 11.2473 8.125 10.75H6.625Z" fill="#1FC16B" />
                </svg>
    ...
    return (
        <Card className="p-4 w-full max-w-lg mx-auto h-auto bg-white dark:bg-neutral-950 border border-gray-200 dark:border-neutral-700 shadow-sm">
            ...
            <div className="space-y-1">
                <div key={activeTab} className="animate-in fade-in slide-in-from-bottom-2 duration-500 ease-out space-y-8">
                    {
                        currentTransactions.map((transaction) => (
                            ...
                            >
                                <div className="flex items-center gap-4">
                                    <div className={`w-10 h-10 rounded-full ${transaction.iconBg} flex items-center justify-center flex-shrink-0 border border-black/5`}>
                                        {transaction.icon}
                                    </div>
                                    <div>
                                        <p className="text-sm font-bold text-black dark:text-white leading-none mb-1.5">{transaction.title}</p>
                                        <p className="text-xs text-gray-800 dark:text-gray-200 font-medium truncate max-w-[140px]">{transaction.description}</p>
                                    </div>
                                </div>
                                <div className="flex items-center gap-3">
                                    <div className="text-right">
                                        ...
                                        <p className="text-xs text-gray-800 dark:text-gray-200 font-medium mt-0.5">{transaction.date}</p>
                                    </div>
                                    <ChevronRight className="w-4 h-4 text-gray-600 dark:text-gray-300 group-hover:text-gray-500 transition-colors" />
                                </div>
                            </div>
                        ))
                    }
