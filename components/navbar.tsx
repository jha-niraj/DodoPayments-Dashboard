...
const Navbar = () => {
    ...
    const handleMoveMoney = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
            const response = await axios.post("/api/movemoney", {
                amount: mmFormData.amount,
                message: mmFormData.message
            });
    ...
    return (
        <>
                ...
                <div className="flex items-center justify-between h-full">
                    <div className="flex items-center gap-4">
                        ...
                        <div className="hidden md:block">
                            ...
                            <p className="text-sm text-gray-800 dark:text-gray-200">Welcome back to Apex 👋</p>
                        </div>
                    </div>
                    <div className="flex items-center gap-2 md:gap-4">
                        <button
                            onClick={() => setIsSearchOpen(true)}
                            className="w-10 h-10 cursor-pointer rounded-lg hover:bg-secondary flex items-center justify-center transition-colors"
                        >
                            <Search className="w-5 h-5 text-muted-foreground" />
                        </button>
                        <DropdownMenu>
                            <DropdownMenuTrigger asChild>
                                <button className="w-10 h-10 cursor-pointer rounded-lg hover:bg-secondary flex items-center justify-center transition-colors relative">
                            ...
                            <DropdownMenuContent align="end" className="w-64">
                                ...
                                <DropdownMenuItem className="cursor-pointer">
                                    <div className="flex flex-col gap-1">
                                        ...
                                        <span className="text-xs text-muted-foreground">You received $120.00 from Sarah</span>
                                    </div>
                                </DropdownMenuItem>
                                <DropdownMenuItem className="cursor-pointer">
                                    <div className="flex flex-col gap-1">
                                        <span className="font-medium">Security Alert</span>
                                        <span className="text-xs text-muted-foreground">New login detected from London</span>
                                    </div>
                                </DropdownMenuItem>
                            </DropdownMenuContent>
                        </DropdownMenu>
            ...
            <Dialog open={isMoveMoneyOpen} onOpenChange={(open) => !open && resetMoveMoney()}>
                <DialogContent className="sm:max-w-[425px] bg-card border-border">

                    {
                        mmStatus === "idle" && (
                            <>
                                <DialogHeader>
                                    <DialogTitle className="text-2xl font-bold">Move Money</DialogTitle>
                                    <DialogDescription>
                                        Enter the amount and a message to send instantly.
                                    </DialogDescription>
                                </DialogHeader>
                                <form onSubmit={handleMoveMoney} className="mt-4">
                                        ...
                                        <div className="grid gap-2">
                                            ...
                                            <div className="relative">
                                                ...
                                                <Input
                                                    ...
                                                    value={mmFormData.amount}
                                                    onChange={(e) => setMmFormData({ ...mmFormData, amount: e.target.value })}
                                                />
                                            </div>
                                        </div>
                                        <div className="grid gap-2">
                                            ...
                                            <Input
                                                ...
                                                value={mmFormData.message}
                                                onChange={(e) => setMmFormData({ ...mmFormData, message: e.target.value })}
                                            />
                                        </div>
                                    </div>
                        ...
                        mmStatus === "processing" && (
                            <div className="py-12 flex flex-col items-center justify-center text-center space-y-4 animate-in fade-in zoom-in duration-300">
                                ...
                                <div>
                                    ...
                                    <p className="text-muted-foreground text-sm">Securely moving your funds...</p>
                                </div>
                            </div>
                        )
                    }
                        ...
                        mmStatus === "success" && (
                            <div className="py-8 flex flex-col items-center justify-center text-center space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <div className="p-4 bg-secondary/50 rounded-lg border border-border mt-4 max-w-xs mx-auto">
                                        <p className="text-xs uppercase tracking-wider text-muted-foreground mb-1">Echo Message</p>
                                        <p className="text-lg font-medium text-blue-600 dark:text-blue-400 italic">
                                            "{mmResult}"
                                        </p>
                                    </div>
                                </div>
