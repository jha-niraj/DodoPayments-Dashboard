...
import { LayoutDashboard, CreditCard, ArrowLeftRight, Receipt, Wallet, RefreshCw, Settings, HelpCircle, ChevronLeft, ChevronRight, X, User, LogOut, ChevronDown } from "lucide-react";
        ...
        <TooltipProvider>
            ...
            >
                ...
                <div className={cn("p-6 flex items-center relative", isCollapsed ? "justify-center" : "gap-3")}>
                    ...
                    {!isCollapsed && (
                        <DropdownMenu>
                            <DropdownMenuTrigger className="hidden md:flex items-center gap-2 hover:opacity-80 transition-opacity outline-none">
                                <div>
                                    <h1 className="font-semibold text-foreground">Apex</h1>
                                    <p className="text-xs text-muted-foreground">{getCurrentDepartmentLabel()}</p>
                                </div>
                            ...
                            {mainNavItems.map((item) => {
                                const ItemContent = (
                                    <NavLink
                                        ...
                                        to={item.to}
                                        className={cn(
                                            "flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm text-muted-foreground hover:bg-secondary transition-colors",
                ...
                <div className="p-4 border-t border-border">
                    ...
                    >
                        <button className={cn("flex items-center gap-3 w-full rounded-lg hover:bg-secondary p-2 transition-colors", isCollapsed && "justify-center")}>
                            <div className="w-10 h-10 rounded-full bg-primary flex items-center justify-center flex-shrink-0">
                        ...
                        {profileDropdownOpen && (
                            ...
                            >
                                <div className="p-4 border-b border-border">
                                    <div className="flex items-center gap-3">
                                        <div className="w-12 h-12 rounded-full bg-primary flex items-center justify-center">
                                            <span className="text-primary-foreground font-medium text-lg">AT</span>
                                        </div>
                                ...
                                <div className="p-2">
                                    <button className="w-full flex items-center gap-3 px-3 py-2.5 text-sm text-muted-foreground hover:text-foreground hover:bg-secondary rounded-md transition-colors">
                                        <div className="w-8 h-8 bg-primary/10 rounded-lg flex items-center justify-center">
                                            <User className="w-4 h-4 text-primary" />
                                        </div>
                                        <span className="font-medium">Profile</span>
                                    </button>
                                    <button className="w-full flex items-center gap-3 px-3 py-2.5 text-sm text-red-600 hover:text-red-700 hover:bg-red-500/10 rounded-md transition-colors">
