...
const Sidebar = () => {
    ...
    const [selectedDepartment, setSelectedDepartment] = useState(() => {
        if (typeof window !== 'undefined') {
            return localStorage.getItem('selectedDepartment') || 'finance';
        }
        return 'finance';
    });
    ...
    const getCurrentDepartmentLabel = () => {
        return DEPARTMENTS.find(d => d.value === selectedDepartment)?.label || "Finance & Banking";
    };
            ...
            const ItemContent = (
                <Link
                    ...
                    className={cn(
                        ...
                        item.status === "coming_soon" && "cursor-pointer"
                    )}
                >
                    <div className="flex-1 text-left min-w-0 flex gap-2">
                        {
                            isActive && (
                        ...
                        <div
                            className={cn(
                                "w-5 h-5 flex-shrink-0 transition-colors flex items-center justify-center",
                                ...
                                <div className="flex items-center gap-2">
                                    ...
                                    {/* {
                                        item.status === "coming_soon" && (
                                            <span className="hidden md:inline text-[10px] px-1.5 py-0.5 rounded-md bg-orange-500/10 text-orange-600 font-medium">
                                                Soon
                                            </span>
                                        )
                                    } */}
    ...
    return (
        <TooltipProvider>
            <button
                ...
                className="fixed top-6 left-6 z-50 md:hidden bg-card border border-border text-foreground p-2 rounded-lg hover:bg-secondary transition-all shadow-lg"
            ...
            <aside
                className={cn(
                    ...
                    "hidden md:flex",
                    isCollapsed ? "md:w-[90px]" : "md:w-64",
                    "md:translate-x-0",
                    isMobileOpen ? "flex translate-x-0 w-[90px]" : "-translate-x-full"
                )}
            >
                <div className={cn("p-6 flex items-center relative", isCollapsed ? "justify-center" : "gap-3")}>
                    {
                        isMobileOpen && (
                            <button
                                onClick={() => setIsMobileOpen(false)}
                                className="absolute top-4 right-4 md:hidden p-1 rounded-lg hover:bg-secondary"
                            >
                                <X className="w-5 h-5" />
                            </button>
                        )
...

                    {
                        !isCollapsed && (
                            <DropdownMenu>
                                <DropdownMenuTrigger className="cursor-pointer hidden md:flex items-center w-full gap-2 hover:opacity-80 transition-opacity outline-none">
                                    <div className="flex-1 text-left min-w-0">
                                        <h1 className="font-semibold text-black dark:text-white truncate">Apex</h1>
                                        <p className="text-xs text-gray-800 dark:text-gray-200 truncate">{getCurrentDepartmentLabel()}</p>
                                    </div>
                                    <div className="flex-shrink-0">
                                        <svg width="12" height="16" viewBox="0 0 9 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M8.62106 4.31049L4.31058 0L0.000103977 4.31049L0.982195 5.29261L4.31058 1.96418L7.63898 5.29261L8.62106 4.31049ZM0 8.41768L4.31051 12.7282L8.62099 8.41768L7.63891 7.4356L4.31051 10.764L0.98209 7.4356L0 8.41768Z" fill="#aef008ff" />
                                        </svg>
                                    </div>
                                </DropdownMenuTrigger>
                                <DropdownMenuContent align="start" className="w-56">
                                    {
                                        DEPARTMENTS.map((dept) => (
                                            <DropdownMenuItem
                                                ...
                                                className={cn(
                                                    "cursor-pointer",
                                                    selectedDepartment === dept.value && "bg-secondary"
                                                )}
                                            >
                                                {dept.label}
                                            </DropdownMenuItem>
                    ...
                    <button
                        ...
                        className="hidden md:block absolute top-6 -right-3 bg-card border border-border rounded-full p-1 hover:bg-secondary transition-colors z-50"
                    >
                ...
                <nav className="flex-1 px-4 overflow-y-auto">
                    <div className="mb-6">
                        {!isCollapsed && <p className="text-xs font-semibold text-muted-foreground mb-3 px-3 hidden md:block">MAIN</p>}
                        <div className="space-y-1">
                            {renderNavItems(mainNavItems)}
                        </div>
                    </div>
                    <div>
                        {!isCollapsed && <p className="text-xs font-semibold text-muted-foreground mb-3 px-3 hidden md:block">OTHERS</p>}
                        <div className="space-y-1">
                                ...
                                </div>
                                {
                                    !isCollapsed && (
                                        <div className="flex-1 text-left hidden md:block min-w-0">
                                            ...
                                            <p className="text-xs text-muted-foreground truncate">arthur@alignui.com</p>
                                        </div>
                                    )
                                }
                            </div>
                                    ...
                                    <div className="p-4 border-b border-border">
                                        <div className="flex items-center gap-3">
                                            ...
                                            <div className="flex-1 min-w-0">
                                                <h3 className="font-semibold text-sm text-foreground truncate">Arthur Taylor</h3>
                                                <p className="text-xs text-muted-foreground truncate">arthur@alignui.com</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="p-2">
                                        <button className="cursor-pointer w-full flex items-center gap-3 px-3 py-2.5 text-sm text-muted-foreground hover:text-foreground hover:bg-secondary rounded-md transition-colors">
                                            <div className="w-8 h-8 bg-primary/10 rounded-lg flex items-center justify-center">
                                                <User className="w-4 h-4 text-primary" />
                                            </div>
                                            <span className="font-medium">Profile</span>
                                        </button>
                                        <button className="cursor-pointer w-full flex items-center gap-3 px-3 py-2.5 text-sm text-red-600 hover:text-red-700 hover:bg-red-500/10 rounded-md transition-colors">
